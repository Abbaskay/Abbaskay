...
Brain tumor imaging system using deep learning for MRI classification
Interactive admin dashboard with map-based heatmap analytics
Automated Binance trading bot with CLI and web interface
Property price prediction model built on real-world housing data
Summarify, an automated book summary web application

Tech Stack
Languages: Python, JavaScript
Frameworks: Flask, Vue, React
Machine Learning: scikit-learn, pandas, numpy
Frontend: Tailwind CSS, Leaflet
